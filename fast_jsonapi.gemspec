...
Gem::Specification.new do |gem|
  ...
  gem.required_ruby_version = ">= 2.3" if gem.respond_to? :required_ruby_version=
  ...
  gem.description = "JSON API(jsonapi.org) serializer that works with rails " \
                    "and can be used to serialize any kind of ruby objects"
  gem.email = ""
